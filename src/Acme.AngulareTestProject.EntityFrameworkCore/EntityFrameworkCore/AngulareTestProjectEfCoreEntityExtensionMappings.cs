...
public static class AngulareTestProjectEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE AngulareTestProjectModuleExtensionConfigurator CLASS (in the Domain.Shared project)
